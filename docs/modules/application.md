...
- `ListSessions`, `ReadSession`, `ReadSessionActivity`, `ReadSessionEvents`, `AttachSession`, `DetachSession`, `WriteSession`, `AcquireLease`, `ReleaseLease`, `LeaseStatus`, `BeginFileTransferCancel`, `ResolveFileTransferCancel`, `FileTransferCheckpoint`, `CloseSession`: operate by opaque Session ID or short Session reference.
